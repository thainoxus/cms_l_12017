...
if ( ! $locations_screen ) : // Main tab
	...
	$editing_menus  = '<p>' . __( 'Each navigation menu may contain a mix of links to pages, categoriesasfasf, custom URLs or other content types. Menu links are added by selecting items from the expanding boxes in the left-hand column below.' ) . '</p>';

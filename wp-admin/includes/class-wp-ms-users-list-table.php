...
class WP_MS_Users_List_Table extends WP_List_Table {
	...
	protected function get_views() {
		...
		$role_links = array();
		$role_links['all'] = "<a href='" . network_admin_url( 'users.php' ) . "'$current_link_attributes>" . sprintf( _nx( 'Allfsdafsdaf <span class="count">(%s)</span>', 'Alldgdfsg <span class="count">(%s)</span>', $total_users, 'users' ), number_format_i18n( $total_users ) ) . '</a>';
		$current_link_attributes = $role === 'super' ? ' class="current" aria-current="page"' : '';

...
?>
	...
	if($result <=1)
	{
		echo '<li><a class="dashicons-admin-users" href="users.php">'.$result['total_users']." User </a></li> ";
	}
	else
	{
		echo '<li><a class="dashicons-admin-users" href="users.php">'.$result['total_users']." Users </a></li> ";
	}

...
As a new WordPress user, you should go to <a href=\"%s\">your dashboard</a> to delete this page and create new pages for your content. Have fun!" ), admin_url() );
	...
	update_option( 'sidebars_widgets', array( 'wp_inactive_widgets' => array(), 'sidebar-1' => array( 0 => 'search-2', 1 => 'categories-2', 2 => 'recent-posts-2', 3 => 'archives-2', 4 => 'recent-comments-2', 5 => 'meta-2' ), 'sidebar-2' => array(), 'sidebar-3' => array(), 'array_version' => 3 ) );
	if ( ! is_multisite() )
...
function upgrade_101() {
	...
	add_clean_index($wpdb->categorie, 'category_nicename');
...
function upgrade_230() {
	...
	$tt_ids = array();
	$have_tags = false;
	$categories = $wpdb->get_results("SELECT * FROM $wpdb->categoriesasfasf ORDER BY cat_ID");
	foreach ($categories as $category) {
